...
ActiveRecord::Schema.define(version: 20170529050842) do
  ...
  add_index "categories", ["slug_en"], name: "index_categories_on_slug_en", using: :btree
  ...
  create_table "websites_categories", id: false, force: :cascade do |t|
    t.integer "website_id",  limit: 4
    t.integer "category_id", limit: 4
  end

  add_index "websites_categories", ["category_id"], name: "index_websites_categories_on_category_id", using: :btree
  add_index "websites_categories", ["website_id"], name: "index_websites_categories_on_website_id", using: :btree
